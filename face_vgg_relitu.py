...
model.load_weights('D:/python/sheep_face/face_vgg_weight/weights_199-0.04579-0.99731.h5')
model.summary()
test_datagen = ImageDataGenerator(rescale=1./255)
seg_test = 'D:/python/sheep_face/jiequ_data/val'
test_generator = test_datagen.flow_from_directory(
        seg_test,
        target_size=(224, 224),
        batch_size=32,
        class_mode='categorical')
labels = {0: 'sheep_1', 1: 'sheep_2', 2: 'sheep_3', 3: 'sheep_4', 4: 'sheep_5', 5: 'sheep_6', 6: 'sheep_7', 7: 'sheep_8'}
