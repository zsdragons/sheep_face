...
def VGG_16(input_shape=(224, 224, 3)):
    ...
    x = Conv2D(512, kernel_regularizer=regularizers.l2(0.001),kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu')(x)
